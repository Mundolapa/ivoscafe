...
const ProductImageGalleryLeftThumb = ({ product, thumbPosition }) => {
  return (
    <div className="product-image-gallery-left-thumb">
      <div className="product-image-gallery-left-thumb-image">
        <img src={process.env.PUBLIC_URL + product.images[thumbPosition]} alt={product.name} />
      </div>
      <div className="product-image-gallery-left-thumb-info">
        <div className="product-image-gallery-left-thumb-info-name">{product.name}</div>
        <div className="product-image-gallery-left-thumb-info-price">{product.price}</div>
      </div>
    </div>
  );
