...
const Checkout = () => {
  ...
  return (
    <Fragment>
      <SEO
        titleTemplate={t("checkout_page_title")}
      ...
      />
        ...
        <Breadcrumb 
          pages={[
            ...
            {label: t('breadcrumb_checkout'), path: process.env.PUBLIC_URL + pathname }
          ]} 
        />
                              ...
                              return (
                                <li key={key}>
                                  <span className="order-middle-left">
                                    {cartItem.title}, {cartItem.selectedAttribute} {cartItem.selectedVariation} X {cartItem.quantity}
                                  </span>{" "}
