...
import GetLayout from '../../layouts/LayoutThree';
...
const ShopGridFilter = () => {
    ...
    return (
        <Fragment>
            <SEO
                titleTemplate={t('shop_grid_page_title')}
                description={t('shop_grid_page_description')}
            />
            ...
            >
                ...
                <Breadcrumb 
                    pages={[
                        ...
                        {label: t('breadcrumb_shop'), path: process.env.PUBLIC_URL + pathname },
                    ]} 
                />
